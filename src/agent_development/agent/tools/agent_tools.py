"""
Agent Tools — Vector search retrieval for documentation context.
Uses Databricks SDK (works on clusters and serving containers).
No dependency on databricks-vectorsearch package.
"""
